SetPrivateProfileString('Multiplayer','Default Permissions','00000001')
SetPrivateProfileString('Multiplayer','Last Protocol Used','1')
SetPrivateProfileString('Multiplayer','Session Name','Thalhalla')
SetPrivateProfileString('Multiplayer','Enable Chat Menu','1')
SetPrivateProfileString('Multiplayer','Disable Banters','1')
SetPrivateProfileString('Multiplayer','Import Character','7')
SetPrivateProfileString('Multiplayer','Player Name','Thoth')
SetPrivateProfileString('Multiplayer','Session Password','icinga')
SetPrivateProfileString('Multiplayer','Pausing Dialog','0')
...
SetPrivateProfileString('Graphics','renderer','Mesa DRI Intel(R) Bay Trail x86/MMX/SSE2')
SetPrivateProfileString('Graphics','Scale UI','0')
SetPrivateProfileString('Graphics','Use Character Highlights','1')
SetPrivateProfileString('Graphics','version','OpenGL version 3.0 Mesa 11.1.2 - build 79')
SetPrivateProfileString('Graphics','Zoom Lock','0')
SetPrivateProfileString('Graphics','vendor','Intel Open Source Technology Center')
...
SetPrivateProfileString('Game Options','Message Box Top','80')
